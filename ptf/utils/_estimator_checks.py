...
def check_estimator(
    ...
    Examples
    --------
    >>> from ptf.models import NBeats
    >>> from ptf.utils import check_estimator
    ...
    {'test_pkg_linkage[NBeats-0]': 'PASSED',
    ...
    from ptf.tests.test_class_register import get_test_classes_for_obj
...
def parametrize_with_checks(objs, obj_varname="obj", check_varname="test_name"):
    ...
    Examples
    --------
    >>> from ptf.utils import parametrize_with_checks
    >>> from ptf.models import DecoderMLP, NBeats
