...
from ptf.layers._blocks._residual_block_dsipts import ResidualBlock
from ptf.layers._embeddings import _sub_nn as sub_nn
from ptf.models.base._base_model_v2 import BaseModel
...
class TIDE(BaseModel):
    ...
    def _pkg(cls):
        ...
        from ptf.models.tide._tide_dsipts import TIDE_pkg_v2
