...
from ptf.data.encoders import NaNLabelEncoder
...
class NHiTS(BaseModelWithCovariates):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :py:class:`~ptf.models.nbeats.NBeats` and also supports covariates.
    ...
    def forward(self, x: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        x : Dict[str, torch.Tensor]
            ...
            :py:class:`~ptf.data.timeseries.TimeSeriesDataSet`.
    ...
    def from_dataset(cls, dataset: TimeSeriesDataSet, **kwargs):
        """
        Convenience function to create network from :py:class`~ptf.data.timeseries.TimeSeriesDataSet`.
