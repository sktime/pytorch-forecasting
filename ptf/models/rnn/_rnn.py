...
from ptf.data.encoders import MultiNormalizer, NaNLabelEncoder
from ptf.data.timeseries import TimeSeriesDataSet
...
from ptf.models.base import AutoRegressiveBaseModelWithCovariates
from ptf.models.nn import HiddenState, MultiEmbedding, get_rnn
from ptf.utils import apply_to_list, to_list
...
class RecurrentNetwork(AutoRegressiveBaseModelWithCovariates):
    ...
    def _pkg(cls):
        ...
        from ptf.models.rnn._rnn_pkg import (
