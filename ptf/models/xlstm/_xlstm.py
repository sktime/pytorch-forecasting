...
from ptf.layers import SeriesDecomposition, mLSTMNetwork, sLSTMNetwork
from ptf.metrics import SMAPE, Metric
from ptf.models.base_model import AutoRegressiveBaseModel
...
class xLSTMTime(AutoRegressiveBaseModel):
    ...
    def _pkg(cls):
        ...
        from ptf.models.xlstm._xlstm_pkg import xLSTMTime_pkg
    ...
    def __init__(
        ...
        **kwargs,
        ...
        loss : ptf.metrics.Metric, default SMAPE()
