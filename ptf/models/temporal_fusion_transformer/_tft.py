...
from ptf.models.nn import LSTM, MultiEmbedding
from ptf.models.temporal_fusion_transformer.sub_modules import (
    AddNorm,
    GateAddNorm,
    GatedLinearUnit,
...
class TemporalFusionTransformer(BaseModelWithCovariates):
    ...
    * capabilities added through base model such as monotone constraints
    ...
    :py:func:`~ptf.models.temporal_fusion_transformer.tuning.optimize_hyperparameters`.
    ...
    **kwargs: additional arguments to :py:class:`~BaseModel`.
    ...
    def _pkg(cls):
        ...
        from ptf.models.temporal_fusion_transformer._tft_pkg import (
