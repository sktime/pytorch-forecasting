...
from ptf.models.base._base_object import _BasePtForecaster
...
class TimeXer_pkg(_BasePtForecaster):
    ...
    def get_cls(cls):
        """Get model class."""
        from ptf.models import TimeXer
    ...
    def _get_test_dataloaders_from(cls, params):
        ...
        from ptf.tests._conftest import make_dataloaders
        from ptf.tests._data_scenarios import data_with_covariates
