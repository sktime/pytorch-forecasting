...
from ptf.base._base_pkg import Base_pkg
...
class TimeXer_pkg_v2(Base_pkg):
    ...
    def get_cls(cls):
        """Get model class."""
        from ptf.models.timexer._timexer_v2 import TimeXer
    ...
    def get_datamodule_cls(cls):
        ...
        from ptf.data.data_module._tslib_data_module import (
            TslibDataModule,
        )
    ...
    def get_test_train_params(cls):
        ...
        """
        from ptf.metrics import QuantileLoss
