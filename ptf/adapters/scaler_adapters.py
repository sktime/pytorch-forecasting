...
from ptf.adapters.scaler_strategy import (
    ScalerStrategy,
)
from ptf.adapters.utils import (
    ArrayLike,
    _to_numpy,
    _to_tensor,
)
...
class ScalerAdapter:
    ...
    scaler : object
        The underlying scaling/encoding instance. Accepted types, their expected
            ...
            * ``MultiNormalizer`` (from ``ptf.data.encoders``):
