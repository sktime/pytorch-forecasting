...
from ptf.utils import repr_class
from ptf.utils._coerce import _coerce_to_dict, _coerce_to_list
...
class TimeSeriesDataSet(Dataset):
    ...
    * generating inference, validation and test datasets
    ...
    target_normalizer : torch transformer, str, list, tuple, optional, default="auto"
        ...
        You can choose from
        :py:class:`~ptf.data.encoders.TorchNormalizer`,
        :py:class:`~ptf.data.encoders.GroupNormalizer`,
        :py:class:`~ptf.data.encoders.NaNLabelEncoder`,
        :py:class:`~ptf.data.encoders.EncoderNormalizer`
        (on which overfitting tests will fail)
        or ``None`` for using no normalizer. For multiple targets, use a
        :py:class`~ptf.data.encoders.MultiNormalizer`.
    ...
    categorical_encoders : dict[str, BaseEstimator]
        ...
        :py:class:`~ptf.data.encoders.NaNLabelEncoder` with
        ``add_nan=True``.
    ...
    scalers : optional, dict with str keys and torch or sklearn scalers as values
        ...
        Other options
        are :py:class:`~ptf.data.encoders.EncoderNormalizer`,
        :py:class:`~ptf.data.encoders.GroupNormalizer`
        ...
        :py:class:`~ptf.data.encoders.EncoderNormalizer` that is
