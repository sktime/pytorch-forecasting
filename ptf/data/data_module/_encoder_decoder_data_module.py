...
from ptf.adapters import ScalerAdapter
...
from ptf.data.timeseries import TimeSeries
from ptf.utils._coerce import _coerce_to_dict
    ...
    def _get_auto_normalizer(self, data_properties: dict) -> NORMALIZER:
        ...
        for target in target_names:
            ...
            if use_encoder_normalizer:
                ...
                from ptf.data.encoders import GroupNormalizer
