...
from ptf.utils import create_mask, unpack_sequence, unsqueeze_like
...
def convert_torchmetric_to_ptf_metric(
...
class MultiLoss(LightningMetric):
    ...
    def __init__(self, metrics: list[LightningMetric], weights: list[float] = None):
        ...
        self.metrics = [
            convert_torchmetric_to_ptf_metric(m) for m in metrics
        ]
