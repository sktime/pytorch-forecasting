"""
Modules for the TemporalFlowTransformer.

Modules are copied from `pytorch-ts <https://github.com/zalandoresearch/pytorch-ts/tree/master/pts/modules>`_.
"""
import copy
import math
...
def create_masks(input_size, hidden_size, n_hidden, input_order="sequential", input_degrees=None):
    ...
    if input_order == "sequential":
        ...
        degrees += (
            [torch.arange(input_size) % input_size - 1] if input_degrees is None else [input_degrees % input_size - 1]
        )
