"""
Modern TCN model for Pytorch Forecasting.
-------------------------------------------
"""
...
class ModernTcn(TslibBaseModel):
    """
    Modern_tcn: Decomposition Linear Model for Long-Term Time Series Forecasting.

    Modern_tcn decomposes time series into trend and seasonal components and applies
    ...
    [2] https://github.com/thuml/Time-Series-Library/blob/main/models/Modern_tcn.py
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        warnings.warn(
            "Modern_tcn is an experimental model implemented on TslibBaseModelV2. "
    ...
    def _init_network(self):
        """
        Initialise the Modern_tcn model network layer components.
        """
    ...
    def forward(self, x: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        """
        Forward pass of the Modern_tcn model.
