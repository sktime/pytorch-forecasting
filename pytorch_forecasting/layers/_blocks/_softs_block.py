...
class STADModule(nn.Module):
    ...
    Aggregates the channel features to a central node, processes them,
    and dispatches back.
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # w: [B, C, L, d_core] -> [B, C, d_core] (pooling over length)
        ...
        # Add dispatched info back to original sequence (broadcasting over length)
