...
def generate_demo_plot():
    ...
    # Since we need 11 steps total (0-10), and max_encoder_length=10,
    # max_prediction_length=1
    ...
    plt.scatter(
        original_time, original_values, color="red", zorder=5, label="Original Data"
    )
    ...
    output_path = os.path.join(os.path.dirname(__file__), "interpolation_demo.png")
